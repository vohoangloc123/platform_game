...
//         if (instance != null)
//         {
//             Debug.LogError("Tìm thấy nhiều Data Persistence Manager trong cảnh");
//         }
//         instance = this;
//     }
...
//         // Nếu không thể tải được dữ liệu, khởi tạo một trò chơi mới
//         if (this.gameData == null)
//         {
//             Debug.Log("Không tìm thấy trò chơi đã lưu. Khởi tạo dữ liệu mặc định");
//             NewGame();
//         }
